...
class DashboardFragment : Fragment() {
    ...
    private fun renderSnapshot(s: DashboardSnapshot) {
        ...
        tvStatusText.text = when {
            safetyScore >= 90 -> "Your device is under maximum protection. No active threats detected."
            safetyScore >= 70 -> "System is stable. Minor suspicious activity blocked."
            else -> "Warning: High volume of suspicious traffic detected. Enable Aggressive Filtering."
        }
    }
