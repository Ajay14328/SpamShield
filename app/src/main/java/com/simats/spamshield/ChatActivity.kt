...
import com.simats.spamshield.RiskCategory
import com.simats.spamshield.FilteredStore
...
class ChatActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val TAG = "SpamShieldChat"
    }
    ...
    private fun setupFeedbackLogic() {
        btnMarkSpam.setOnClickListener {
            ...
            Toast.makeText(this, "Neural Engine updated: Sender flagged as Spam", Toast.LENGTH_SHORT).show()
        ...
        btnMarkSafe.setOnClickListener {
            ...
            Toast.makeText(this, "Neural Engine updated: Sender marked as Trusted", Toast.LENGTH_SHORT).show()
            feedbackBanner.visibility = View.GONE
